...
RUN cp startup/* /startup || true && \
	...
	apt-get update && apt-get install -y tmux libpq-dev libldap-dev libsasl2-dev postgresql-client-common postgresql-client gettext gcc git libgl1 && rm -rf /var/lib/apt/lists/* && \
